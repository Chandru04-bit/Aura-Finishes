...
const serviceImages = Object.freeze({
  ...
  'texture-finishing': 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=900&q=75',
  'waterproofing': 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=900&h=800&q=75',
...
const SERVICE_IMAGE_URLS = serviceImages;
...
const SERVICES_DATA = Object.freeze({
  'interior-painting': {
    ...
    image: SERVICE_IMAGE_URLS['interior-painting'],
    ...
    afterImage: SERVICE_IMAGE_URLS['interior-painting'],
  ...
  'exterior-painting': {
    ...
    image: SERVICE_IMAGE_URLS['exterior-painting'],
  ...
  'wall-finishing': {
    ...
    image: SERVICE_IMAGE_URLS['wall-finishing'],
    ...
    afterImage: SERVICE_IMAGE_URLS['wall-finishing'],
  ...
  'texture-finishing': {
    ...
    image: SERVICE_IMAGE_URLS['texture-finishing'],
  ...
  'waterproofing': {
    ...
    image: SERVICE_IMAGE_URLS['waterproofing'],
  ...
  'decorative-painting': {
    ...
    image: SERVICE_IMAGE_URLS['decorative-painting'],
  ...
  'commercial-painting': {
    ...
    image: SERVICE_IMAGE_URLS['commercial-painting'],
    ...
    afterImage: SERVICE_IMAGE_URLS['commercial-painting'],
  ...
  'industrial-painting': {
    ...
    image: SERVICE_IMAGE_URLS['industrial-painting'],
    ...
    afterImage: SERVICE_IMAGE_URLS['industrial-painting'],
...
const portfolioImages = Object.freeze({
  ...
  'hudson-yards-tech-hq': 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=800&q=75',
  ...
  'upper-east-side-classic': 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=800&q=75',
  'interior-finish': 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=800&q=75',
  ...
  'westchester-stone-manor': 'https://images.unsplash.com/photo-1592595896551-12b371d546d5?auto=format&fit=crop&w=800&h=600&q=75',
...
const PROJECT_IMAGE_URLS = portfolioImages;
...
const PORTFOLIO_PROJECTS_LIST = Object.freeze([
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=800&q=75',
    area: '12,000 sq.ft.',
  ...
  },
  {
    ...
    filterCategory: 'residential exterior',
    location: 'Bedford, NY',
    image: 'https://images.unsplash.com/photo-1592595896551-12b371d546d5?auto=format&fit=crop&w=800&h=600&q=75',
    area: '11,000 sq.ft.',
    duration: '6 Weeks Execution'
  },
  {
...
const PROJECTS_DATA = Object.freeze({
  ...
  'hudson-yards-tech-hq': {
    ...
    image: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=900&q=75',
    mainImage: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=900&q=75',
    ...
    afterImage: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1000&h=800&q=75',
  ...
  'soho-art-loft-residence': {
    ...
    mainImage: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=900&q=75',
    ...
    afterImage: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=1000&h=800&q=75',
  ...
  'upper-east-side-classic': {
    ...
    mainImage: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=900&q=75',
    ...
    afterImage: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1000&h=800&q=75',
  ...
  'westchester-stone-manor': {
    ...
    image: 'https://images.unsplash.com/photo-1592595896551-12b371d546d5?auto=format&fit=crop&w=800&h=600&q=75',
    mainImage: 'https://images.unsplash.com/photo-1592595896551-12b371d546d5?auto=format&fit=crop&w=800&h=600&q=75',
...
const ARTICLES_DATA = Object.freeze({
  ...
  'venetian-plaster-vs-limewash': {
    ...
    readTime: '8 min read',
    heroImage: 'images/about/craftsmanship-artisan.jpg',
...
function initServiceDetailsPage() {
  ...
  const slug = Object.hasOwn(SERVICES_DATA, requestedSlug) ? requestedSlug : 'interior-painting';
  ...
  if (navEl) {
    navEl.innerHTML = Object.entries(SERVICES_DATA).map(([serviceSlug, item]) => {
...
function initNavbarDropdowns() {
  ...
  dropdownItems.forEach(dropdown => {
    ...
    // Toggle on click / tap across desktop and mobile
    toggle.addEventListener('click', (e) => {
      ...
      document.querySelectorAll('.main-header .nav-item.dropdown.show').forEach(other => {
        if (other !== dropdown) {
  ...
  document.addEventListener('click', (e) => {
    if (!e.target.closest('.main-header .nav-item.dropdown')) {
      document.querySelectorAll('.main-header .nav-item.dropdown.show').forEach(dropdown => {
        dropdown.classList.remove('show');
...
/* ==========================================================================
   5.1 MOBILE NAVIGATION & BODY SCROLL LOCKING
   ========================================================================== */
function initMobileNav() {
  const mainNavbarCollapse = document.getElementById('mainNavbar');
  const navbarToggler = document.querySelector('.navbar-toggler');
  if (!mainNavbarCollapse) return;

  // Lock body scroll when mobile navigation is opened
  mainNavbarCollapse.addEventListener('show.bs.collapse', () => {
  ...
  // Restore normal page scroll when mobile navigation is closed
  mainNavbarCollapse.addEventListener('hidden.bs.collapse', () => {
  ...
  // Close mobile nav when clicking non-dropdown navigation links
  const navLinks = mainNavbarCollapse.querySelectorAll('.nav-link:not(.dropdown-toggle), .dropdown-item, .auth-btn');
  navLinks.forEach(link => {
    link.addEventListener('click', () => {
      if (window.innerWidth < 992 && mainNavbarCollapse.classList.contains('show')) {
        if (window.bootstrap && bootstrap.Collapse) {
          ...
          mainNavbarCollapse.classList.remove('show');
          document.body.classList.remove('mobile-nav-open');
        }
      }
    });
  ...
  // Close mobile nav when clicking outside header and collapse
  document.addEventListener('click', (e) => {
    if (window.innerWidth < 992 && mainNavbarCollapse.classList.contains('show')) {
      if (!mainNavbarCollapse.contains(e.target) && !e.target.closest('.navbar-toggler')) {
        if (window.bootstrap && bootstrap.Collapse) {
          const bsCollapse = bootstrap.Collapse.getInstance(mainNavbarCollapse) || new bootstrap.Collapse(mainNavbarCollapse, { toggle: false });
          bsCollapse.hide();
        } else {
  ...
  document.addEventListener('keydown', (e) => {
    if (e.key === 'Escape' && window.innerWidth < 992 && mainNavbarCollapse.classList.contains('show')) {
      if (window.bootstrap && bootstrap.Collapse) {
        const bsCollapse = bootstrap.Collapse.getInstance(mainNavbarCollapse) || new bootstrap.Collapse(mainNavbarCollapse, { toggle: false });
        bsCollapse.hide();
      } else {
  ...
  // Reset lock and close mobile menu if viewport resized to desktop breakpoint
  window.addEventListener('resize', () => {
    if (window.innerWidth >= 992) {
      document.body.classList.remove('mobile-nav-open');
      if (mainNavbarCollapse.classList.contains('show')) {
        if (window.bootstrap && bootstrap.Collapse) {
          const bsCollapse = bootstrap.Collapse.getInstance(mainNavbarCollapse);
          if (bsCollapse) {
            bsCollapse.hide();
          } else {
            mainNavbarCollapse.classList.remove('show');
...
function initPortfolioGrid() {
  // Target dedicated dynamic portfolio container if defined
  const container = document.querySelector('#portfolioGrid, .portfolio-grid-dynamic');
  if (!container) return;

  // Strict isolation check: NEVER overwrite any container holding service cards
  if (container.querySelector('.service-card') || document.querySelector('.service-card')) return;

  // Only hydrate if empty, preserving static SEO markup if present
